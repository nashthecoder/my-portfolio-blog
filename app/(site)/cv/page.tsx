      ...
      <div className="page-container py-12">
        ...
        <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:'2.5rem', flexWrap:'wrap', gap:'1rem' }}>
          <div>
            ...
            <p style={{ fontSize:'20px', color:C.crimson, fontWeight:'500' }}>Systems Architect · Fractional Product CTO · FemTech Founder</p>
            <p style={{ fontSize:'17px', color:C.muted, marginTop:'4px' }}>Nairobi, Kenya · naijeriatoweett.com</p>
          </div>
          <a href="/Naijeria_Toweett_CV_2026.pdf" download
            style={{ fontSize:'17px', fontWeight:'500', padding:'0.55rem 1.25rem', borderRadius:'100px', background:C.crimson, color:'#fff', textDecoration:'none', alignSelf:'flex-start' }}>
            Download PDF ↓
          </a>
        </div>
        ...
        <div style={{ marginTop:'3rem', paddingTop:'2rem', borderTop:`1px solid ${C.border}`, display:'flex', gap:'10px', flexWrap:'wrap' }}>
          <a href="https://quickjobs.naijeriatoweett.com/" target="_blank" rel="noopener noreferrer"
            style={{ fontSize:'17px', fontWeight:'500', padding:'0.6rem 1.4rem', borderRadius:'100px', background:C.crimson, color:'#fff', textDecoration:'none' }}>
            Brief me on a project →
          </a>
          <a href="https://www.linkedin.com/in/naijeriatoweett/" target="_blank" rel="noopener noreferrer"
            style={{ fontSize:'17px', padding:'0.6rem 1.35rem', borderRadius:'100px', border:`1px solid ${C.border}`, color:C.charcoal, textDecoration:'none' }}>
            Connect on LinkedIn
          </a>
        </div>
