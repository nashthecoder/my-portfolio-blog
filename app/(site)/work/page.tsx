...
const ALL_PROJECTS = [
  ...
  { _id:'2', title:'AskRafikey', client:'Digital Health Coalition of Kenya', sector:'healthtech',
    ...
    screenshot_url:'/images/work/askrafikey.png', screenshot_label:'AskRafikey screenshot' },
  { _id:'3', title:'Incident Tracker', client:'Youth Changers Kenya', sector:'civic',
    summary:'A purpose-built Progressive Web App for survivors, community members, and YCK volunteers to log incidents securely, automate response workflows, and generate anonymized reports — even without internet access.',
    impact_metric:'Offline-first · PWA', tags:['PWA','Offline-first','Civic Tech','Youth Protection','FHIR'],
    external_url:'https://tich-labs.github.io/yck-incident-tracker/en', live_url:'https://tich-labs.github.io/yck-incident-tracker/en',
    delivers:['Secure offline incident logging', 'AI-powered risk assessment', 'Automated workflow notifications', 'FHIR-compatible health records', 'Anonymized PDF reporting'],
    screenshot_url:'/images/work/incident-tracker.png', screenshot_label:'Incident Tracker screenshot' },
  { _id:'4', title:'Mama Tech Teaches', client:'Mama Tech', sector:'education',
    ...
    screenshot_url:'/images/work/mamatech.png', screenshot_label:'Mama Tech Teaches screenshot' },
  { _id:'5', title:'Njiapanda', client:'TichLabs', sector:'civic',
    ...
    screenshot_url:'/images/work/njiapanda.png', screenshot_label:'Njiapanda screenshot' },
  { _id:'6', title:'DADA', client:'Mama Tech / TichLabs', sector:'femtech',
            ...
            return (
              <article key={p._id}
                ...
                <div style={{ position:'relative', minHeight:'320px', background:'#FBF4F1', order: i % 2 === 0 ? 1 : 2 }}>
                  {p.cover_image ? (
                    <Image src={p.cover_image} alt={p.title} fill style={{ objectFit:'contain' }} />
                  ) : p.screenshot_url ? (
                    <a href={p.external_url || p.live_url || '#'} target="_blank" rel="noopener noreferrer" style={{ display:'block', width:'100%', height:'100%' }}>
                      <Image src={p.screenshot_url} alt={p.screenshot_label} fill style={{ objectFit:'contain' }} />
                    </a>
